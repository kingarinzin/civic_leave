    ...
    <div className="flex bg-slate-50 min-h-screen">
      ...
      <main className="flex-1 p-6 ml-64">
        ...
        <Flex align="center" justify="between" mb="5" wrap="wrap">
          ...
          {/* ========================================================= */}
          {/* ✅ EDIT BUTTON - Toggles Edit Mode (STAYS ON SAME PAGE) */}
          {/* ========================================================= */}
          <Flex gap="2">
            {!isEditing ? (
              <>
                        ...
                        {isEditing ? (
                          ...
                          <>
                            ...
                            <div className="mt-1">
                              ...
                              <select
                                multiple
                                value={getDepartmentArray(meeting)}
                                onChange={(e) => {
                              ...
                              {getDepartmentArray(meeting).length > 0 && (
                                <div className="flex flex-wrap gap-1 mt-1">
                                  {getDepartmentArray(meeting).map((dept) => (
                                    <Badge key={dept} variant="soft" color="blue" size="1">
                                      {dept}
                                    </Badge>
                                  ))}
                                </div>
