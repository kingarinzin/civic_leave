...
export default function AddWeeklyPlanPage(): React.ReactElement {
  ...
  // State for tasks and legend (copied from previous plan)
  const [tasks, setTasks] = useState<string[]>([]);
  const [legendItems, setLegendItems] = useState<{ key: string; value: string }[]>([]);

  // Track custom stakeholder input
  ...
  const handleReset = (): void => {
    ...
    setCustomLocation({});
    setStakeholderInput({});
    // Reset tasks and legend to empty (they will be re-fetched on reload, but we reset for consistency)
    setTasks([]);
    setLegendItems([]);
  };
        ...
        <Card size="3">
          <form onSubmit={handleSubmit}>
            <Flex direction="column" gap="4">
              ...
              {/* ========================================================= */}
              {/* TASKS SECTION (Copied from previous plan) */}
              {/* ========================================================= */}
              <Box>
              ...
              {/* ========================================================= */}
              {/* LEGEND SECTION (Copied from previous plan) */}
              {/* ========================================================= */}
              <Box>
                <Flex align="center" justify="between" mb="2">
                  <Box>
