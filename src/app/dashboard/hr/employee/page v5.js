...
export default function HREmployeePage() {
  ...
  // ================== EDIT START (WITH DEFAULT PARENT AGENCY) ==================
  const startEdit = (employee) => {
    setEditingCid(employee.cidNumber);
    setEditData({
      gender: employee.gender || "",
      parentAgency: employee.parentAgency || "Anti-Corruption Commission", // ✅ DEFAULT
      mog: employee.mog || "",
                              ...
                              {isEditing ? (
                                ...
                                <div className="p-6">
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <InputField
                                      label="Parent Agency"
                                      value={editData.parentAgency || "Anti-Corruption Commission"} // ✅ DEFAULT
