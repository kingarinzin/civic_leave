                  ...
                  return (
                    <React.Fragment key={item.cidNumber}>
                      <tr className="hover:bg-gray-100 transition-colors">
                        ...
                        {/* ✅ Full Name column with avatar/photo */}
                        <td className="px-6 py-3 text-sm">
                          <div className="flex items-center gap-2">
                            <div className="flex-shrink-0 w-8 h-8 rounded-full overflow-hidden bg-blue-100 flex items-center justify-center border border-gray-200">
                              {item.passportPhoto ? (
                                <img
                      ...
                      {/* Expanded details row (professional layout – unchanged) */}
                      {isExpanded && (
                        <tr>
