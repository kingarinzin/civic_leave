...
export default function HREmployeePage() {
  ...
  const startEdit = (employee) => {
    ...
    setEditData({
      ...
      parentAgency: employee.parentAgency || "",
      mog: employee.mog || "",
  ...
  const handlePhotoUpload = async (cid) => {
                ...
                paginated.map((item, index) => {
                  ...
                  return (
                    <React.Fragment key={item.cidNumber}>
                      ...
                      {/* ========== EXPANDED DETAILS (Professional Layout) ========== */}
                      {isExpanded && (
                        <tr>
                          <td colSpan="7" className="px-6 py-6 bg-blue-50/50">
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                              ...
                              {isEditing ? (
                                ...
                                <div className="p-6">
                                  <div className="flex justify-between items-center mb-4">
                                    <h4 className="font-semibold text-lg">Edit Custom HR Fields</h4>
                                    <button
                                      onClick={cancelEdit}
                                ...
                                <div className="p-6">
                                  {/* Two‑column grid with grouped fields */}
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                                    ...
                                    {/* Right column – HR Custom & Agency */}
                                    <div className="space-y-4">
                                      <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider border-b pb-1">
                                        HR Custom Fields
                                      </h4>
                                      <InfoItem icon={Building} label="Parent Agency" value={item.parentAgency} />
                                      ...
                                      <InfoItem icon={GraduationCap} label="Qualification" value={item.qualification} />
                                  ...
                                  <div className="mt-6 pt-4 border-t border-gray-200 flex items-center gap-4 flex-wrap">
                                    ...
                                    />
                                    <button
                                      onClick={() => handlePhotoUpload(item.cidNumber)}
                                      disabled={uploadingPhoto}
...
// ---------- NEW: InfoItem for Professional Layout ----------
